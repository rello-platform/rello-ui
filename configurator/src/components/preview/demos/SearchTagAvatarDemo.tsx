    ...
    <div className="bg-[var(--neutral-50)] rounded-xl overflow-hidden border border-[var(--neutral-200)]">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map(tag => (
            <span key={tag} className="inline-flex items-center justify-center gap-1.5 px-3 py-[5px] text-[13px] font-semibold font-ui leading-none rounded-lg shadow-[0_1px_1px_0.5px_rgba(0,0,0,0.6)] bg-[var(--neutral-100)] text-[var(--neutral-600)]" style={{ animation: "tag-in 150ms ease-out" }}>
          ...
          <button onClick={() => setTags(prev => [...prev, `Tag ${prev.length + 1}`])} className="inline-flex items-center justify-center px-3 py-[5px] text-[13px] font-semibold font-ui leading-none rounded-lg border border-dashed border-[var(--neutral-300)] text-[var(--neutral-500)] hover:bg-[var(--neutral-100)]">+ Add</button>
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <span key={t.label} className="inline-flex items-center justify-center gap-1.5 px-3 py-[5px] text-[13px] font-semibold font-ui leading-none rounded-lg shadow-[0_1px_1px_0.5px_rgba(0,0,0,0.6)]" style={{ backgroundColor: t.bg, color: t.text }}>
              {t.label}
