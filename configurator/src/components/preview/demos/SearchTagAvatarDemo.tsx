    ...
    <div className="bg-[var(--neutral-50)] rounded-xl overflow-hidden border border-[var(--neutral-200)]">
      ...
      <div className="p-4">
        ...
        <div className="flex flex-wrap gap-2">
          {tags.map(tag => (
            <span key={tag} className="inline-flex items-center justify-center gap-1.5 px-3 py-[5px] text-[13px] font-semibold font-ui leading-none rounded-lg shadow-[0_1px_1px_0.5px_rgba(0,0,0,0.4)] bg-[var(--neutral-100)] text-[var(--neutral-600)]" style={{ animation: "tag-in 150ms ease-out" }}>
        ...
        <div className="flex flex-wrap gap-2">
          {[
            ...
            <span key={t.label} className="inline-flex items-center justify-center gap-1.5 px-3 py-[5px] text-[13px] font-semibold font-ui leading-none rounded-lg shadow-[0_1px_1px_0.5px_rgba(0,0,0,0.4)]" style={{ backgroundColor: t.bg, color: t.text }}>
              {t.label}
